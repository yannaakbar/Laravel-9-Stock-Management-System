...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="danger_level">Harga</label>
            ...
            <div class="form-group">
                <label class="required" for="satuan">{{ trans('cruds.asset.fields.satuan') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.asset.fields.satuan_helper') }}</span>
            </div>
            <div class="form-group">
